...
export const translations = {
  en: {
    ...
    recentClear: "Clear",
    livePopularityKicker: "LIVE USAGE",
    livePopularityTitle: "Most used right now",
    trendingKicker: "Activity",
  ...
  vi: {
    ...
    recentClear: "Xoá",
    livePopularityKicker: "SỬ DỤNG THỰC",
    livePopularityTitle: "Đang được dùng nhiều nhất",
    trendingKicker: "Hoạt động",
